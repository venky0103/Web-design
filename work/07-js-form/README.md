...
- The form will use a variety of validation methods, as described below
  - This is not showing the "best" way - this is practicing the different options
...
- A "real" form would not have this mix of methods, but this assignment shows that you can build whatever validation your team decides to use.
...
- The validations must NOT be done with HTML validations
  ...
  - No `type="email"` - use `type="text"` (the default for input elements) instead
